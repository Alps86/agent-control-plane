...
4. Aufgaben und Ergebnisse einer anderen Organisation sind weder im Teamkontext noch in To-do-Ansichten sichtbar. Teammitgliedschaft erweitert weder Daten-, Tool- noch Delegationsrechte. Der Organigrammweg wird sichtbar, erlaubt aber allein keine Übergabe; deren Ausführung und Rechteprüfung gehören zu DEL-01. Auftraggeber, koordinierendes Team und ausführender Agent bleiben getrennt nachvollziehbar. Die Chatkontextgrenze wird anschließend in ZA-01 geprüft.

**Abhängigkeiten:** ORG-01 für die Organisation, TASK-01 für die gemeinsame Aufgabenbasis, AGT-04 für das Organigramm und PERM-01 für die Organisations- und Datengrenze [Primäre Gates: Story-11, Story-17, Story-37, Story-19]. Für die tatsächlich verwendete Agentenart gilt pfadabhängig AGT-01 (Story-15) oder AGT-02 (Story-16), nicht beides zugleich; auch zwei Teammitglieder desselben Typs erfüllen diesen Pfad. ORG-02 und PROJ-01 sind über AGT-04 beziehungsweise TASK-01 bereits vorausgesetzt. Tatsächliche Übergaben folgen DEL-01 und sind keine ZA-02-Abnahme. Gesicherte Beispiele: [Organisation](../akzeptanzbeispiele/bestand/organisationen/organisation-anlegen.md), [Organigramm](../akzeptanzbeispiele/bestand/organisationen/delegation.md), [Agenten](../akzeptanzbeispiele/bestand/agenten/agenten-anlegen.md), [Projekte](../akzeptanzbeispiele/bestand/projekte/projekte.md), [Aufgaben](../akzeptanzbeispiele/bestand/aufgaben/aufgaben.md), [Rechte](../akzeptanzbeispiele/bestand/berechtigungen/rechte.md). ZA-02 legt Teamidentität, Mitgliedschaft und To-do-Sichten unabhängig vom Chat an; ZA-01 verwendet diese Teamidentität später als Chatadressat. Keine andere ZA-Story ist Voraussetzung.
...
Jede Story wird über öffentliche Anwendungsgrenzen mit Godog geprüft; sichtbare Bedienwege werden zusätzlich im Browser geprüft, sobald ein nutzbarer Stand verfügbar ist. Die 31 früheren fachlichen Beispiele sind als [Markdown](../akzeptanzbeispiele/bestand/zusammenarbeit/) gesichert; künftige ausführbare Fälle liegen unter `features/app/<fachbereich>/` und `features/ui/<fachbereich>/`. Ein UI-Prototyp oder ein Modelltext allein erfüllt keine Story, deren Kriterium eine dauerhafte Aktion oder Rechteprüfung verlangt.
